...
You can submit this App online at [https://doi.org/10.25663/brainlife.app.484](https://doi.org/10.25663/brainlife.app.484) via the 'Execute' tab.
...
```json
{
    ...
    "lh_annot": "/input/parcellation/left.gii",
    "rh_annot": "/input/parcellation/right.gii",
