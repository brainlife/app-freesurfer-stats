...
You can submit this App online at [https://doi.org/10.25663/brainlife.app.464](https://doi.org/10.25663/brainlife.app.464) via the 'Execute' tab.
...
```json
{
    ...
    "lh_annot": "/input/parcellation/lh.parc.annot.gii",
    "rh_annot": "/input/parcellation/rh.parc.annot.gii",
